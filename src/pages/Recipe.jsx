...
//       try {
//         const response = await fetch(
//           `https://api.spoonacular.com/recipes/${id}/information?includeNutrition=false&apiKey=93aa82b85ab84dbc9dc569b6f94ab1ab`
//         );
//         if (!response.ok) throw new Error("Failed to fetch recipe");
//         const data = await response.json();
//         setRecipe(data);
...
//           animate={{ y: 0, opacity: 1 }}
//           transition={{ delay: 0.3 }}
//           className="text-5xl font-bold text-center text-red-400 mb-8"
//         >
//           {recipe.title}
//         </motion.h1>
//         <motion.img
